...
| Bloque Analítico | Control de Versiones y Celdas Evaluadas | Razón de la Refactorización y Mejora Obtenida |
| :--- | :--- | :--- |
| **Carga de Entorno** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: Celda 1<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: Celda 1 *(Librerías estándar)*<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: Celda 1 *(Sin cambios)*<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 1 *(Añade multipletests)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 2 *(Configuración estética global, supresión de alertas)* | Profesionaliza el entorno ocultando advertencias de sintaxis y fijando una paleta homogénea (`Set2`). |
| **Control SRM (Muestra)** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: Celda 4 *(Mapeo plano)*<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 4 *(Cálculo Chi² manual)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 5 *(Validación robusta p=0.8572)* | **Eliminación de sesgo:** Asegura matemáticamente que el ruteo de usuarios fue totalmente balanceado y limpio. |
| **Filtro de Contaminación** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: No existente<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 5 *(Cruce de IDs)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 6 *(Reporte de duplicados = 0)* | **Garantía de Rigor:** Valida que ningún usuario haya sido expuesto a ambas variantes de manera simultánea. |
| **Efecto Novedad** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: No existente<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 6 *(Eje de tiempo vacío)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celdas 7-8 *(Serie diaria + Análisis de estabilidad)* | **Protección de Falsos Positivos:** Confirma que el éxito de B es stable y duradero, no una anomalía inicial. |
| **Análisis de Gasto** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: Vacío asignado<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: Celda 5 *(t-test estándar)*<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: Celda 6 *(t-test estándar)*<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 10-11 *(Levene + t-Welch + MWU)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 11-13 *(Añade Cohen's d = 0.2498)* | **Precisión Estadística:** Levene detectó varianzas distintas, obligando a cambiar a una robusta **t de Welch**. |
| **Control de Outliers** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: No existente<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 12 *(Filtro estadístico IQR)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 14-15 *(Comparativa de medias con/sin atípicos)* | **Robustez del Negocio:** Demuestra que la mejora en gasto no se debe a compradores masivos anómalos aislados. |
| **Métrica Reina (RPV)** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: No existente<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 15 *(Cálculo simple)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 16-18 *(Resolución formal de la Paradoja)* | **Traducción Financiera:** Unifica conversión y ticket promedio para reflejar un aumento directo del **+42.8%** por visita. |
| **Resolución del Error Crítico** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: Celda 15 *(Detiene ejecución por `KeyError: 'device'`)*<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 18 *(Parchado rudimentario)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celdas 19-23 *(Mapeo dinámico de variables reales)* | **Estabilidad de Software:** Elimina referencias a columnas muertas inexistentes en el archivo físico del dataset. |
| **Reducción de Ruido** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: No existente<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: No existente<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: No existente<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celda 24 *(Agrega V de Cramér / Bonferroni)*<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celdas Eliminadas por Diseño | **Navaja de Ockham:** Remoción de sobre-ingeniería matemática que no aportaba valor a la toma de decisiones. |
| **Dashboard Ejecutivo** | • `<a href="./S9%20Version_Student_Proyecto_Landing_Experiment.ipynb">S9_Version_Student_Proyecto_Landing_Experiment.ipynb</a>`: Celdas vacías<br>• `<a href="./notebooks/1_Github_AB_Test_Analysis_Final.ipynb">1_Github_AB_Test_Analysis_Final.ipynb</a>`: Gráficos dispersos sin anotaciones<br>• `<a href="./notebooks/2_AB_Test_Analysis_mejorado.ipynb">2_AB_Test_Analysis_mejorado.ipynb</a>`: Gráficos individuales con `FutureWarning`<br>• `<a href="./notebooks/3_AB_Test_Analysis_v2.ipynb">3_AB_Test_Analysis_v2.ipynb</a>`: Celdas de dibujo independientes<br>• `<a href="./4_Proyecto_Final_AB_Test.ipynb">4_Proyecto_Final_AB_Test.ipynb</a>`: Celda 26 *(Exportación de panel unificado PNG)* | **Estándar de Production-Ready:** Consolida métricas clave en una única imagen lista para el C-Level. |
---
