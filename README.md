...
| Bloque Analítico | Mapeo de Celdas y Estado por Notebook | Razón de la Refactorización y Mejora Obtenida |
| :--- | :--- | :--- |
| **Carga de Entorno** | • **S9_Version...:** Celda 1<br>• **1_Github_AB...:** Celda 1 *(Librerías estándar)*<br>• **2_AB_Test_An...:** Celda 1 *(Sin cambios)*<br>• **3_AB_Test_An...:** Celda 1 *(Añade multipletests)*<br>• **4_Proyecto_F...:** Celda 2 *(Configuración estética global, supresión de alertas)* | Profesionaliza el entorno ocultando advertencias de sintaxis y fijando una paleta homogénea (`Set2`). |
| **Control SRM (Muestra)** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** Celda 4 *(Mapeo plano)*<br>• **3_AB_Test_An...:** Celda 4 *(Cálculo Chi² manual)*<br>• **4_Proyecto_F...:** Celda 5 *(Validación robusta p=0.8572)* | **Eliminación de sesgo:** Asegura matemáticamente que el ruteo de usuarios fue totalmente balanceado y limpio. |
| **Filtro de Contaminación** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** No existente<br>• **3_AB_Test_An...:** Celda 5 *(Cruce de IDs)*<br>• **4_Proyecto_F...:** Celda 6 *(Reporte de duplicados = 0)* | **Garantía de Rigor:** Valida que ningún usuario haya sido expuesto a ambas variantes de manera simultánea. |
| **Efecto Novedad** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** No existente<br>• **3_AB_Test_An...:** Celda 6 *(Eje de tiempo vacío)*<br>• **4_Proyecto_F...:** Celdas 7-8 *(Serie diaria + Análisis de estabilidad)* | **Protección de Falsos Positivos:** Confirma que el éxito de B es estable y duradero, no una anomalía inicial. |
| **Análisis de Gasto** | • **S9_Version...:** Vacío asignado<br>• **1_Github_AB...:** Celda 5 *(t-test estándar)*<br>• **2_AB_Test_An...:** Celda 6 *(t-test estándar)*<br>• **3_AB_Test_An...:** Celda 10-11 *(Levene + t-Welch + MWU)*<br>• **4_Proyecto_F...:** Celda 11-13 *(Añade Cohen's d = 0.2498)* | **Precisión Estadística:** Levene detectó varianzas distintas, obligando a cambiar a una robusta **t de Welch**. |
| **Control de Outliers** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** No existente<br>• **3_AB_Test_An...:** Celda 12 *(Filtro estadístico IQR)*<br>• **4_Proyecto_F...:** Celda 14-15 *(Comparativa de medias con/sin atípicos)* | **Robustez del Negocio:** Demuestra que la mejora en gasto no se debe a compradores masivos anómalos aislados. |
| **Métrica Reina (RPV)** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** No existente<br>• **3_AB_Test_An...:** Celda 15 *(Cálculo simple)*<br>• **4_Proyecto_F...:** Celda 16-18 *(Resolución formal de la Paradoja)* | **Traducción Financiera:** Unifica conversión y ticket promedio para reflejar un aumento directo del **+42.8%** por visita. |
| **Resolución del Error Crítico** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** Celda 15 *(Detiene ejecución por `KeyError: 'device'`)*<br>• **3_AB_Test_An...:** Celda 18 *(Parchado rudimentario)*<br>• **4_Proyecto_F...:** Celdas 19-23 *(Mapeo dinámico de variables reales)* | **Estabilidad de Software:** Elimina referencias a columnas muertas inexistentes en el archivo físico del dataset. |
| **Reducción de Ruido** | • **S9_Version...:** No existente<br>• **1_Github_AB...:** No existente<br>• **2_AB_Test_An...:** No existente<br>• **3_AB_Test_An...:** Celda 24 *(Agrega V de Cramér / Bonferroni)*<br>• **4_Proyecto_F...:** Celdas Eliminadas por Diseño | **Navaja de Ockham:** Remoción de sobre-ingeniería matemática que no aportaba valor a la toma de decisiones. |
| **Dashboard Ejecutivo** | • **S9_Version...:** Celdas vacías<br>• **1_Github_AB...:** Gráficos dispersos sin anotaciones<br>• **2_AB_Test_An...:** Gráficos individuales con `FutureWarning`<br>• **3_AB_Test_An...:** Celdas de dibujo independientes<br>• **4_Proyecto_F...:** Celda 26 *(Exportación de panel unificado PNG)* | **Estándar de Production-Ready:** Consolida métricas clave en una única imagen lista para el C-Level. |
---
